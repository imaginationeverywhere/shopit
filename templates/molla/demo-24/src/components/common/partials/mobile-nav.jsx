      ...
      <ul className="mobile-menu">
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              <Link to={`${process.env.PUBLIC_URL}/shop/nosidebar/fullwidth`}>
                Shop Fullwidth No Sidebar
              </Link>
            </li>
            <li>
              <Link to={`${process.env.PUBLIC_URL}/shop/category/boxed`}>
                Product Category Boxed
              </Link>
            </li>
            <li>
              <Link to={`${process.env.PUBLIC_URL}/shop/category/fullwidth`}>
                <span>
            ...
            <li>
              <Link to={`${process.env.PUBLIC_URL}/shop/cart`}>Cart</Link>
            </li>
            <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              <Link to={`${process.env.PUBLIC_URL}/product/fullwidth/2`}>
                Full Width
              </Link>
            </li>
            <li>
        ...
        <li>
          <Link to={`${process.env.PUBLIC_URL}/pages/about`}>Pages</Link>
          <ul>
            <li>
              <Link
        ...
        <li>
          <Link
            to={`${process.env.PUBLIC_URL}/elements/list`}
            className="sf-with-ul"
          >
            Elements
          </Link>
