...
function SingleFullWidthSidebar(props) {
  ...
  return (
    <>
      <Helmet>
        <title>
          Molla React eCommerce Template | Blog Fullwidth No Sidebar
        </title>
      </Helmet>
                ...
                <article className="entry single-entry">
                  <div className="entry-body">
                    ...
                    <div className="entry-content editor-content">
                      ...
                      <img
                        src={`${process.env.PUBLIC_URL}/assets/images/blog/single/fullwidth-sidebar/4.jpg`}
                        alt="blog"
                      />
                      <img
                        src={`${process.env.PUBLIC_URL}/assets/images/blog/single/fullwidth-sidebar/5.jpg`}
                        alt="blog"
                      />
                      ...
                      <p>
                        Praesent <Link to="#">elementum hendrerit</Link> tortor.
