...
function CTATwo( props ) {
    return (
        <div className="container">
            <div className="cta cta-separator cta-border-image cta-half mb-0" style={ { backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/home/bg-2.jpg)` } }>
...
export default React.memo( CTATwo );