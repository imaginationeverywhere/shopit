            ...
            <div className="widget-body">
              <Accordion>
                ...
                <Card title="TV & Video">
                  <ul>
                    <li>
                      <Link to="#">AV Receivers &amp; Amplifiers</Link>
                    </li>
                    <li>
                      <Link to="#">Blu-ray Players &amp; Recorders</Link>
                    </li>
                    <li>
                      <Link to="#">DVD Players &amp; Recorders</Link>
                    </li>
                    <li>
                      <Link to="#">HD DVD Players</Link>
                    </li>
                    <li>
                      <Link to="#">Home Theater Systems</Link>
                    </li>
                    <li>
                      <Link to="#">Projection Screens</Link>
                    </li>
                    <li>
                      <Link to="#">Projectors</Link>
                    </li>
                    <li>
                      <Link to="#">Satellite Television</Link>
                    </li>
                    <li>
                      <Link to="#">Televisions</Link>
                    </li>
                    <li>
                      <Link to="#">TV-DVD Combos</Link>
                    </li>
                    <li>
                ...
                <Card title="Cell Phone">
                  <ul>
                    <li>
                      <Link to="#">Carrier Cell Phones</Link>
                    </li>
                    <li>
                      <Link to="#">Unlocked Cell Phones</Link>
                    </li>
                    <li>
                      <Link to="#">Mobile Broadband</Link>
                    </li>
                    <li>
                      <Link to="#">Accessories</Link>
                    </li>
                    <li>
                      <Link to="#">Cases, Holsters &amp; Clips</Link>
                    </li>
                  </ul>
                </Card>
