...
function SingleFullWidth(props) {
  ...
  return (
    <>
      <Helmet>
        <title>
          Molla React eCommerce Template | Blog Fullwidth With Sidebar
        </title>
      </Helmet>
          ...
          <div className="container">
                  ...
                  <div className="entry-body">
                    ...
                    <div className="entry-content editor-content">
                      ...
                      <p>
                        ...
                        lacus a <Link to="#">ultrices sagittis</Link>, mi neque
                      ...
                      <p>
                        ...
                        mattis eget, gravida vitae, ultricies ac, leo. Integer
                      ...
                      <img
                        src={`${process.env.PUBLIC_URL}/assets/images/blog/single/fullwidth/2.jpg`}
                        alt="desc"
                      />
                      ...
                      <p>
                        ...
                        eget, gravida vitae, ultricies ac, leo. Integer leo
                      ...
                      <img
                        src={`${process.env.PUBLIC_URL}/assets/images/blog/single/fullwidth/3.jpg`}
                        alt="desc"
                      />
                      ...
                      <p>
                        ...
                        dapibus sed, urna. Morbi interdum mollis sapien. Sed ac
                        risus. Phasellus lacinia, magna a ullamcorper laoreet,
                        lectus arcu pulvinar risus, vitae facilisis libero dolor
                        a purus. Sed vel lacus. Mauris nibh felis, adipiscing
                        varius, adipiscing in, lacinia vel, tellus. Suspendisse
                        ac urna. Etiam pellentesque mauris ut lectus. Nunc
                        tellus ante, mattis eget, gravida vitae, ultricies ac,
                        leo. Integer leo pede, ornare a, lacinia eu, vulputate
                        vel, nisl.
                      </p>
                    </div>
            ...
            >
              <Link
                ...
                to={`${process.env.PUBLIC_URL}/blog/single-2/${prevId}`}
                aria-label="Previous"
                tabIndex="-1"
              >
                Previous Post
              ...
              <Link
                ...
                to={`${process.env.PUBLIC_URL}/blog/single-2/${nextId}`}
                aria-label="Next"
                tabIndex="-1"
              >
                Next Post
