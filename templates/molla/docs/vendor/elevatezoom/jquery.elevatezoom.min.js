  ...
  (function (o, i, t, e) {
    var n = {
      init: function (i, t) {
        ...
        (e.elem = t),
          (e.$elem = o(t)),
          (e.imageSrc = e.$elem.attr('data-zoom-image')
            ? e.$elem.attr('data-zoom-image')
            : e.$elem.attr('href')
            ? e.$elem.attr('href')
            : e.$elem.data('original')
            ? e.$elem.data('original')
            : e.$elem.attr('src')),
          ...
          o('#' + e.options.gallery + ' a').click(function (i) {
            return (
              ...
              i.preventDefault(),
              o(this).attr('data-zoom-image')
                ? (e.zoomImagePre = o(this).attr('data-zoom-image'))
        ...
        'window' == i.options.zoomType &&
          ...
          'round' == i.options.lensShape &&
            (i.lensRound =
              ...
              'px;'),
          void 0 !== i.ctOffset &&
            (i.$container.find('.zoomContainer').length &&
              i.$container.find('.zoomContainer').remove(),
            (i.zoomContainer = o(
