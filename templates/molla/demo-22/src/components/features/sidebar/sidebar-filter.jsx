          ...
          <div className="my-collapsible">
            <div className="toolbox toolbox-filter">
              <div className="toolbox-left">
                <button className="button filter-toggler" onClick={onToggle}>
                  Filters
                </button>
                <button
                  className="button filter-toggler mobile-mode"
                  onClick={showSideBar}
                >
                  Filters
                </button>
              ...
              <div className="toolbox-right">
                <ul className="nav-filter product-filter">
                  ...
                  <li>
                    <Link to="#" data-filter=".Furniture">
                      Furniture
                    </Link>
                  </li>
                  <li>
                    <Link to="#" data-filter=".Lighting">
                      Lighting
                    </Link>
                  </li>
                  <li>
                    <Link to="#" data-filter=".Accessories">
                      Accessories
                    </Link>
                  </li>
                  <li>
                    <Link to="#" data-filter=".Sale">
                      Sale
                    </Link>
                  </li>
                </ul>
              ...
              <div className="my-collapsible__content-inner">
                <div className="widget-filter-area" id="product-filter-area">
                  <div className="clean-close">
                    ...
                    <Link to="#" onClick={hideSideBar} className="widget-close">
                            ...
                            {categories.map((cat, index) => (
                              ...
                              >
                                ...
                                <span className="item-count">
                                  {categoryCountArr[parseInt(index)]}
                                </span>
                              </div>
                            ))}
                          </div>
                        ...
                        <div className="widget">
                          ...
                          <div className="filter-colors filter-colors-vertical">
                            {colors.map((col, index) => (
                              ...
                              >
                                <span>{colorNames[parseInt(index)]}</span>
                              </Link>
                            ))}
                          </div>
                        </div>
