  ...
  return (
    <Switch>
      <Layout>
        ...
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/listing`}
          component={Listing}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/grid/2cols`}
          component={Grid2Cols}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/grid/3cols`}
          component={Grid3Cols}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/grid/4cols`}
          component={Grid4Cols}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/grid/sidebar`}
          component={GridSidebar}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/masonry/2cols`}
          component={Masonry2Cols}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/masonry/3cols`}
          component={Masonry3Cols}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/masonry/4cols`}
          component={Masonry4Cols}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/masonry/sidebar`}
          component={MasonrySidebar}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/mask/grid`}
          component={MaskGrid}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/mask/masonry`}
          component={MaskMasonry}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/single/:id`}
          component={SingleDefault}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/single-2/:id`}
          component={SingleNoSidebar}
        />
        <Route
          exact
          path={`${process.env.PUBLIC_URL}/blog/single-3/:id`}
          component={SingleFwSidebar}
        />
      </Layout>
    </Switch>
  );
