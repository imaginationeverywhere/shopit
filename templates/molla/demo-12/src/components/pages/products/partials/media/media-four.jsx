                ...
                <div id="product-zoom-gallery" className="product-image-gallery product-gallery-masonry">
                    {
                        product.pictures.map( ( item, index ) =>
                            parseInt( index ) > 0 ?
                                <Link className={ `product-gallery-item ${2 === index ? 'gallery-item-wide' : ''}` } to="#" data-image={ process.env.PUBLIC_URL + '/' + item } data-zoom-image={ process.env.PUBLIC_URL + '/' + bigImages[ index ] } key={ index }>
