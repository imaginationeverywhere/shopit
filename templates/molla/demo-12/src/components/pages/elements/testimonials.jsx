      ...
      <div className="main">
        ...
        <div className="page-content">
          <div className="container">
            ...
            <OwlCarousel
              adClass="owl-theme owl-testimonials cols-1"
              carouselOptions={mainSlider5}
              carouselId="testi_one"
            >
              <Testimonial
            ...
            <h2 className="title text-center mb-3">
              Quote Sign <span className="title-separator">/</span> Centered
              Align <span className="title-separator">/</span> 2 Columns
            </h2>

            <OwlCarousel
              adClass="owl-theme owl-testimonials cols-md-2 cols-1"
              carouselOptions={mainSlider6}
              carouselId="testi_two"
            >
              <Testimonial
            ...
            <OwlCarousel
              adClass="owl-theme owl-testimonials cols-1 cols-md-2 cols-lg-3"
              carouselOptions={mainSlider7}
              carouselId="testi_three"
            >
              <Testimonial
          ...
          <div
            className="bg-image bg-overlay pt-5 pb-4 bg-parallax"
            style={{
          ...
          >
            <div className="container">
              ...
              <OwlCarousel
                adClass="owl-theme owl-testimonials owl-light cols-1"
                carouselOptions={mainSlider5}
                carouselId="testi_four"
              >
                <Testimonial
                  content="“ Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, dapibus id, mattis vel, nisi. Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh. Nullam mollis. Ut justo. Suspendisse potenti. ”"
                  name="Jenson Gregory"
          ...
          <div className="container">
            <h2 className="title text-center mb-3">
              Customer Photo <span className="title-separator">/</span> Centered
              Align
            </h2>

            <OwlCarousel
              adClass="owl-theme owl-testimonials-photo cols-1"
              carouselOptions={mainSlider5}
              carouselId="testi_five"
            >
              <Testimonial
                content="“ Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, dapibus id, mattis vel, nisi. Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh. Nullam mollis. Ut justo. Suspendisse potenti. ”"
                name="Jenson Gregory"
            ...
            <OwlCarousel
              adClass="owl-theme owl-testimonials-photo cols-1 cols-md-2"
              carouselOptions={mainSlider6}
              carouselId="testi_six"
            >
              <Testimonial
                content="“  Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Phasellus hendrerit. Pellentesque aliquet nibh nec urna. In nisi neque, aliquet vel, dapibus id, mattis vel, nisi tortor eu nibh. Nullam mollis.  ”"
                name="Jenson Gregory"
