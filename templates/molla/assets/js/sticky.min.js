            ...
            if (o.minWidth && n.width() <= o.minWidth)
              ...
              if (void 0 !== f) {
                ...
                p.css('border-bottom', m),
                  ...
                  p.parent().css('height', p.outerHeight() + g),
            ...
            for (
              ...
              if (m) {
                ...
                if (
                  ...
                  var b = m.from - m.pad.bottom,
                    C = m.to - m.pad.top - m.offset;
                  if (
                    (void 0 !== m.fromFitTop &&
                      m.fromFitTop &&
                      (b = m.fromFitTop - m.pad.bottom),
                    b + u.outerHeight() > m.end || b >= C)
                  ) {
