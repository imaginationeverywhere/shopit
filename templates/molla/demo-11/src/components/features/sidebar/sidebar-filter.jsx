                                                            ...
                                                            <div className="filter-item" key={ `category_${index}` }>
                                                                <div className="custom-control custom-checkbox">
                                                                    <input type="checkbox"
                                                                        ...
                                                                        defaultChecked={ filters[ "category" ] && -1 < filters[ "category" ].indexOf( cat ) ? true : false } />
                                                            ...
                                                            <div className="filter-item" key={ `sortBy_${index}` }>
                                                                <div className="custom-control custom-checkbox">
                                                                    <input type="radio"
                                                                        ...
                                                                        name="sortby"
                                                                        defaultChecked={
                                                                            !filters[ "sortBy" ] && parseInt( index ) === 2 ? true :
                                                    ...
                                                    <div className="filter-colors filter-colors-vertical">
                                                        { colors.map( ( col, index ) =>
                                                            <Link to="#"
                                                                ...
                                                                className={ filters[ "color" ] && -1 < filters[ "color" ].indexOf( col ) ? "selected" : "" }
