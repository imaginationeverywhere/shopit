        ...
        <div className="page-content">
          <div className="container">
            ...
            <div className="heading heading-flex">
              <div className="heading-left">
                <h2 className="title">
                  Simple title <span className="title-separator">/</span> Link
                </h2>
              </div>

              <div className="heading-right">
                <Link to="#" className="title-link">
                  Click here to view <i className="icon-long-arrow-right"></i>
                </Link>
              </div>
            </div>
            <p>
            ...
            <div className="heading heading-flex">
              ...
              <div className="heading-right">
                <Link to="#" className="title-link link-underline">
                  Click here to view <i className="icon-long-arrow-right"></i>
                </Link>
              </div>
            </div>
            ...
            <div className="heading">
              ...
              <h2 className="title-sm">
                Small title <span className="title-separator">/</span> Subtitle
              </h2>
            </div>
            <p>
              Sed egestas, ante et vulputate volutpat, eros pede semper est,
