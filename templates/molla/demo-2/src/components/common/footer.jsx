...
function Footer( props ) {
    const { logo = "assets/images/logo-footer.png", width = "105", height = "25", container = "container" } = props;
                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="widget">
                                ...
                                <ul className="widget-list">
                                    <li><Link to={ `${process.env.PUBLIC_URL}/pages/about` }>About Molla</Link></li>
