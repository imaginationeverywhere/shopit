...
function Categories() {
  return (
    <>
      ...
      <h1 className="d-none">
        Molla React eCommerce Template - Product Category
      </h1>
        ...
        <div className="page-content">
          <div className="container">
            ...
            <div className="row">
              <div className="col-md-6">
                <ProductCategoryOne
                  image={`assets/images/category/banner-1.jpg`}
                  category="Women"
                  count="18"
                />
              </div>
              ...
              <div className="col-md-6">
                <ProductCategoryOne
                  image={`assets/images/category/banner-2.jpg`}
                  category="Men"
                  count="12"
                />
              </div>
            ...
            <div className="row justify-content-center">
              <div className="col-md-6 col-lg-4">
                <ProductCategoryTwo
                  image={`assets/images/category/3cols/banner-1.jpg`}
                  category="Women"
                  count="18"
                />
              </div>
              ...
              <div className="col-md-6 col-lg-4">
                <ProductCategoryTwo
                  image={`assets/images/category/3cols/banner-2.jpg`}
                  category="Men"
                  count="12"
                />
              </div>
              ...
              <div className="col-md-6 col-lg-4">
                <ProductCategoryTwo
                  image={`assets/images/category/3cols/banner-3.jpg`}
            ...
            <OwlCarousel adClass="owl-simple" carouselOptions={mainSlider3}>
              <ProductCategoryThree
                image={`assets/images/category/4cols/banner-1.jpg`}
                category="Women"
                count="18"
              />
              <ProductCategoryThree
                image={`assets/images/category/4cols/banner-2.jpg`}
                category="Men"
                count="12"
              />
              <ProductCategoryThree
                image={`assets/images/category/4cols/banner-3.jpg`}
                category="Shoes & Boots"
                count="15"
              />
              <ProductCategoryThree
                image={`assets/images/category/4cols/banner-4.jpg`}
                category="Accessories"
                count="8"
              />
              <ProductCategoryThree
          ...
          <div className="container-fluid">
            ...
            <div className="row justify-content-center">
              <div className="col-md-6 col-lg-4">
                <ProductCategoryOne
                  image={`assets/images/category/fullwidth/banner-1.jpg`}
                  category="Women"
                  count="18"
                />
              </div>
              ...
              <div className="col-md-6 col-lg-4">
                <ProductCategoryOne
                  image={`assets/images/category/fullwidth/banner-2.jpg`}
                  category="Men"
                  count="12"
                />
              </div>
              ...
              <div className="col-md-6 col-lg-4">
                <ProductCategoryOne
                  image={`assets/images/category/fullwidth/banner-3.jpg`}
                  category="Accessories"
                  count="12"
                />
              </div>
          ...
          <div className="container">
            ...
            <div className="row justify-content-center">
              <div className="col-sm-6 col-lg-3">
                <ProductCategoryFour
                  image={`assets/images/category/grid/banner-1.jpg`}
                  category="Accessories"
                  count="8"
                  type="banner-content-bottom"
                />
              </div>

              <div className="col-sm-6 col-lg-3 order-lg-last">
                <ProductCategoryFour
                  image={`assets/images/category/grid/banner-4.jpg`}
                  category="Shoes & Boots"
                  count="15"
                  type="banner-content-top"
                />
              </div>
              ...
              <div className="col-lg-6">
                <div className="row">
                  <div className="col-sm-6 col-lg-12">
                    <ProductCategoryFour
                      image={`assets/images/category/grid/banner-2.jpg`}
                      category="Women"
                      count="18"
                    />
                  </div>
                  ...
                  <div className="col-sm-6 col-lg-12">
                    <ProductCategoryFour
                      image={`assets/images/category/grid/banner-3.jpg`}
                      category="Men"
                      count="12"
                    />
                  </div>
            ...
            <div className="row ">
              <div className="col-md-6">
                <ProductCategoryFive
                  image={`assets/images/category/grid2/banner-1.jpg`}
                  category="Accessories"
                  count="8"
                />
              </div>
              <div className="col-md-6">
                <ProductCategoryFive
                  image={`assets/images/category/grid2/banner-2.jpg`}
                  category="Women"
                  count="15"
                />
                <ProductCategoryFive
                  image={`assets/images/category/grid2/banner-3.jpg`}
                  category="Men"
                  count="12"
                />
              </div>
