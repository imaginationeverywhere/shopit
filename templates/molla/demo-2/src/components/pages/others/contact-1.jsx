    ...
    <div className="main">
      ...
      <div className="container">
        <div
          ...
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/contact-header-bg.jpg)`,
          }}
        >
                  ...
                  <div className="row">
                    <div className="col-sm-5 col-xl-6">
                      <figure className="store-media mb-2 mb-lg-0">
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/stores/img-1.jpg`}
                          alt="desc"
                        />
                      </figure>
                    </div>
                    <div className="col-sm-7 col-xl-6">
                      <div className="store-content">
                        ...
                        <Link to="#" className="btn btn-link" target="_blank">
                          <span>View Map</span>
                          <i className="icon-long-arrow-right"></i>
                        </Link>
                      </div>
                ...
                <div className="store">
                  <div className="row">
                    <div className="col-sm-5 col-xl-6">
                      <figure className="store-media mb-2 mb-lg-0">
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/stores/img-2.jpg`}
                          alt="desc"
                        />
                      </figure>
                    </div>
