...
export default function CTA() {
  ...
  return (
    <>
      ...
      <h1 className="d-none">
        Molla React eCommerce Template - Call To Action
      </h1>
        ...
        <div className="page-content pb-0">
          <div className="container">
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/backgrounds/cta/bg-1.jpg)`,
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/backgrounds/bg-large.jpg)`,
            }}
          >
            <div className="container">
          ...
          <div className="container">
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/backgrounds/cta/bg-5.jpg)`,
                backgroundPosition: `center right`,
              }}
            >
              <div className="row">
                <div className="col-lg-6">
                  <div className="cta-wrapper cta-text text-center">
                    <h3 className="cta-title">
                      Morbi in sem quis dui placerat pellentesque felis.
                    </h3>
                    <p className="cta-desc">
            ...
            <div className="row">
              <div className="col-lg-6">
                <div
                  ...
                  style={{
                    backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/backgrounds/cta/bg-3.jpg)`,
                    backgroundPosition: `center right`,
                  }}
                >
                  <div className="cta-wrapper cta-text text-center">
              ...
              <div className="col-lg-6">
                <div
                  className="cta bg-image mb-3"
                  style={{
                    backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/backgrounds/cta/bg-4.jpg)`,
                    backgroundPosition: `center right`,
                  }}
                >
                  <div className="cta-wrapper text-center">
          ...
          <div className="container">
            <h2 className="title text-center mb-5">
              Sale Banner <span className="title-separator">/</span> With
              Background
            </h2>
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/backgrounds/cta/bg-2.jpg)`,
                backgroundPosition: `center right`,
              }}
            >
              <div className="row justify-content-center">
                <div className="col-sm-10 col-md-8 col-lg-6">
                  <div className="cta-text text-center">
                    <h3 className="cta-title">
                      Morbi in sem quis dui placerat felis.
                    </h3>
                    <p className="cta-desc">
                      Morbi in sem quis dui placerat ornare. Pellentesque odio
                      nisi, euismod in, pharetra a, ultricies in, diam. Sed
            ...
            <hr className="mb-5" />
            <h2 className="title text-center mb-5">
              Sale Banner <span className="title-separator">/</span> With Dark
              Background
            </h2>
          </div>
