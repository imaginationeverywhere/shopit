...
function SingleDefault(props) {
  ...
  return (
    <>
      <Helmet>
        <title>
          Molla React eCommerce Template | Blog Default With Sidebar
        </title>
      </Helmet>
                ...
                <article className="entry single-entry">
                  ...
                  <div className="entry-body">
                    ...
                    <div className="entry-content editor-content">
                      ...
                      <img
                        src={`${process.env.PUBLIC_URL}/assets/images/blog/single/2.jpg`}
                        alt="desc"
                      ...
                      <img
                        src={`${process.env.PUBLIC_URL}/assets/images/blog/single/3.jpg`}
                        alt="desc"
                      />
