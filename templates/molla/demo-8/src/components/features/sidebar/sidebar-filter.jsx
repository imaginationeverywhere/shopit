                    ...
                    <div className="my-collapsible">
                        <div className="toolbox toolbox-filter">
                            <div className="toolbox-left">
                                <button className="button filter-toggler" onClick={ onToggle }>Filters</button>
                                                ...
                                                <div className="widget">
                                                    ...
                                                    <div className="filter-price">
                                                        <div className="filter-price-text">
                                                            Price Range:&nbsp;
                                                            <span className="filter-price-range">${ state.value.min } - ${ state.value.max }</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="price-slider">
                                                        <InputRange
                                                            ...
                                                            step={ 50 }
                                                            value={ state.value }
                                                            onChange={ value => { setState( { value } ); props.filterPrice( value ); } } />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
