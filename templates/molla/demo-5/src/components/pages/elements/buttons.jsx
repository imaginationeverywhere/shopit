          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col-6 col-lg-4 col-xl-2">
                <div className="btn-wrap">
                  <span>Rounded Corners Style</span>
                  <Link to="#" className="btn btn-outline-primary btn-rounded">
                    Button text
                  </Link>
                </div>
              </div>
              ...
              <div className="col-6 col-lg-4 col-xl-2">
                <div className="btn-wrap">
                  <span>Round Style</span>
                  <Link to="#" className="btn btn-outline-primary btn-round">
                    Button text
                  </Link>
                </div>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-6 col-lg-4 col-xl-2">
                <div className="btn-wrap">
                  <span>Square Style</span>
                  <Link to="#" className="btn btn-primary btn-shadow">
                    Button text
                  </Link>
                </div>
              </div>
              ...
              <div className="col-6 col-lg-4 col-xl-2">
                <div className="btn-wrap">
                  <span>Round Style</span>
                  <Link to="#" className="btn btn-primary btn-round btn-shadow">
                    Button text
                  </Link>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-12">
                ...
                <Link to="#" className="btn btn-link btn-link-dark">
                  Button Text
                </Link>
                <Link to="#" className="btn btn-link btn-link-dark">
                  <span>Button Text</span>
