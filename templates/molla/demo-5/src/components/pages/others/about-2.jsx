    ...
    <div className="main">
      ...
      <div className="page-content pb-3">
        <div className="container">
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="about-text text-center mt-3">
                ...
                />
                <img
                  src={`${process.env.PUBLIC_URL}/assets/images/about/about-2/img-1.jpg`}
                  alt="temp"
          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-sm-6">
              <IconBox
                boxStyle="icon-box-sm text-center"
                iconClass="icon-puzzle-piece"
                title="Design Quality"
                text="Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero <br/>eu augue."
              />
            </div>
            <div className="col-lg-4 col-sm-6">
              <IconBox
                ...
                text="Praesent dapibus, neque id cursus faucibus, <br/>tortor neque egestas augue, eu vulputate <br/>magna eros eu erat. "
              />
            </div>
            <div className="col-lg-4 col-sm-6">
              <IconBox
                ...
                text="Pellentesque a diam sit amet mi ullamcorper <br/>vehicula. Nullam quis massa sit amet <br/>nibh viverra malesuada."
              />
            </div>
          </div>
        </div>
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/backgrounds/bg-4.jpg)`,
          }}
        >
          <div className="container">
            <div className="row">
