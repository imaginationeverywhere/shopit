...
class Trending = () => {
    ...
    return <div className="tranding-area margin-top-70 ">
            ...
            <div className="row">
              <div className="col-lg-12">
                <ul className="nav nav-pills tranding-tab">
                  <li className="mt-3"><a data-toggle="pill" href="#one" className="active">BEST SELLER</a></li>
                  <li className="mt-3"><a data-toggle="pill" href="#two">TOP RATE</a></li>
                  <li className="mt-3"><a data-toggle="pill" href="#three">TOP SALE</a></li>
                </ul>
              </div>
            </div>
