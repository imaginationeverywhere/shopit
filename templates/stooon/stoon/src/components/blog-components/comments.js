           ...
           <ul className="comment-list">
             <li>
               <div className="single-comment-wrap">
                 <div className="thumb">
                   <img src={ publicUrl+"/assets/img/news/16.png"} alt={ imagealt } />
                 </div>
                 <div className="content">
                   ...
                   <a href="#" className="like"><i className="fa fa-heart-o" />Like 235</a>
             ...
             <li>
               <div className="single-comment-wrap">
                 <div className="thumb">
                   <img src={ publicUrl+"/assets/img/news/17.png"} alt={ imagealt } />
                 </div>
                 <div className="content">
                   <h4 className="title">Sara Koivisto</h4>
                   <p>Fun kitchen and not cookie cutter! The appliance garage is easy to access and good looking on the inside too. I’ve also recently remodeled my kitchen and eliminated </p>
             ...
             <li>
               <div className="single-comment-wrap">
                 <div className="thumb">
                   <img src={ publicUrl+"/assets/img/news/18.png"} alt={ imagealt } />
                 </div>
                 <div className="content">
                   <h4 className="title">Sara Koivisto</h4>
                   <p>Fun kitchen and not cookie cutter! The appliance garage is easy to access and good looking on the inside too. I’ve also recently remodeled my kitchen and eliminated </p>
