              ...
              <div className="col-lg-4 col-8">
                <div className="contact">
                  <a href="tel:+496170961709">
                    <i className="icon-call-header" /> (939) 353-1107
                  </a>
                  <a href="#">
                    <i className="icon-email-subscribe" /> support@example.com
                  </a>
                </div>
              </div>
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <ul className="user-dropdown">
                        ...
                        <li>
                          <a href="#">
                            <i className="fa fa-briefcase" /> My Orders
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <i className="fa fa-reply" /> Returns Information
                          </a>
                        </li>
                        <li>
                          <a href="#">
                            <i className="fa fa-commenting-o" /> Contact
                            Preferences
                          </a>
                        </li>
                      </ul>
                  ...
                  <ul>
                    ...
                    <li className="has-dropdown">
                      <a href="#">
                        ...
                        <span className="badge badge-green total-count"></span>
                      </a>
                      <ul>
