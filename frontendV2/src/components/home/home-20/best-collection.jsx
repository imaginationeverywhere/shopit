...
function BestColllection(props) {
  ...
  if (type === 'best') products = getTopSellingProducts(products);
  else products = getFeaturedProducts(products);

  return (
    <OwlCarousel
      adClass="carousel-equal-height owl-simple"
      carouselOptions={type === 'best' ? productSlider3 : productSlider4}
    >
