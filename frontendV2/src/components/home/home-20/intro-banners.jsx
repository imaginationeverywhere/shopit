    ...
    <div className="row">
      <div className="col-md-12 col-lg-6">
        <div className="banner banner-big banner-overlay">
          <Link to="#">
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/demos/demo-20/banners/banner-1.jpg`}
              alt="Banner"
            />
          </Link>
          ...
          <div className="banner-content">
            <h4 className="banner-subtitle text-white">
              <Link to="#">Your Guide To The World</Link>
            </h4>
            ...
            >
              Find out more<i className="icon-long-arrow-right"></i>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="col-sm-6 col-lg-3">
        <div className="banner banner-overlay">
          <Link to="#">
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/demos/demo-20/banners/banner-2.jpg`}
              alt="Banner"
            />
          </Link>
      ...
      <div className="col-sm-6 col-lg-3">
        <div className="banner banner-small banner-overlay">
          <Link to="#">
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/demos/demo-20/banners/banner-3.jpg`}
              alt="Banner"
            />
          </Link>
        ...
        <div className="banner banner-small banner-overlay">
          <Link to="#">
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/demos/demo-20/banners/banner-4.jpg`}
              alt="Banner"
            />
          </Link>
