...
function DealCollection(props) {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/home/banners/bg-1.jpg)`,
      }}
    >
            ...
            <div className="row deal-products">
              <div className="deal-product col-6 text-center">
                <figure className="product-media">
                  <Link
                    to={`${process.env.PUBLIC_URL}/product/default/${products[1].id}`}
                  >
                    <img
                      src={
                ...
                <div className="product-body pt-2">
                  <div className="product-price">
                    <span className="new-price">
                      Now $
                      {products[1].salePrice.toLocaleString(undefined, {
                    ...
                    <span className="old-price">
                      Was $
                      {products[1].price.toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </span>
              ...
              <div className="deal-product col-6 text-center">
                <figure className="product-media">
                  <Link
                    to={`${process.env.PUBLIC_URL}/product/default/${products[0].id}`}
                  >
                    <img
                      src={
                ...
                <div className="product-body pt-2">
                  <div className="product-price">
                    <span className="new-price">
                      Now $
                      {products[0].salePrice.toLocaleString(undefined, {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </span>
