    ...
    <>
      ...
      <div className="main home-page">
            ...
            >
              <div className="container intro-content text-center">
                ...
                <h1 className="intro-title text-white">
                  Spring Lookbook {new Date().getFullYear()}
                </h1>

                <Link
                  to="#scroll-to-content"
                  className="btn btn-outline-primary-2 scroll-to"
        ...
        <VideoBanner
          ...
          content={`<span>Spring / Summer</span>The New Romantic Collection ${new Date().getFullYear()}`}
          adClass="video-fullheight"
        />
