            ...
            if (paymentIntent.status === "succeeded") {
                ...
                console.log(paymentIntent)
                    ; (async () => {
                        ...
                        const orderDetails = await axios.post(API_URL + 'order/finalize', { orderId, paymentIntentId: paymentIntent.id }, config)
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="summary">
                                            <h3 className="summary-title">Order Successfully Created</h3>
