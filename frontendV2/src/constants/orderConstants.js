...
export const CREATE_DRAFT_ORDER_REQUEST = 'CREATE_DRAFT_ORDER_REQUEST';
export const CREATE_DRAFT_ORDER_SUCCESS = 'CREATE_DRAFT_ORDER_SUCCESS';
export const CREATE_DRAFT_ORDER_FAIL = 'CREATE_DRAFT_ORDER_FAIL';

export const UPDATE_ORDER_SHIPPING_REQUEST = 'UPDATE_ORDER_SHIPPING_REQUEST';
export const UPDATE_ORDER_SHIPPING_SUCCESS = 'UPDATE_ORDER_SHIPPING_SUCCESS';
export const UPDATE_ORDER_SHIPPING_FAIL = 'UPDATE_ORDER_SHIPPING_FAIL';
